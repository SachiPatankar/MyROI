...
//   const EMIRecord = sequelize.define('emi_record', {
//     loan_amount: { type: Sequelize.DECIMAL(15, 2) },
//     interest_rate: { type: Sequelize.DECIMAL(5, 2) },
//     loan_tenure_months: { type: Sequelize.INTEGER },
//     emi: { type: Sequelize.DECIMAL(15, 2) },
//     prepayment_amount: { type: Sequelize.DECIMAL(15, 2), defaultValue: 0 },
//     remaining_balance: { type: Sequelize.DECIMAL(15, 2) }
//   });
//   return EMIRecord;
// };
...
//     MonthlyPayment,
//     associate: (models) => {
//       EMIRecord.hasMany(models.MonthlyPayment, {
//         foreignKey: 'emiRecordId',
//         as: 'monthlyPayments'
//       });
//       MonthlyPayment.belongsTo(models.EMIRecord, {
//         foreignKey: 'emiRecordId',
//         as: 'emiRecord'
//       });
//     }
